...
Q = '${units 500 W}' # Heat source amplitude
...
[Mesh]
  ...
  [rename_block_name]
    ...
    input = cmg
    old_block = '0 1'
    new_block = 'wall_block porous_block'
  []
  ...
  [wall_left_boundary_2]
    ...
    block_id = 0
    bottom_left = '0 2.5273 0'
    top_right = '0.1 2.5400 0'
    boundaries_old = left
    boundary_new = wall_left
  []
  ...
  [refine]
    ...
    input = fluid_left_boundary
    block = 'wall_block porous_block'
    refinement = '1 1'
  []
...
[Functions]
  [vol_heat_rate]
    ...
    type = ParsedFunction
    expression = 'Q * exp((log(f) / T) * t)'
    symbol_names = 'Q f T'
    symbol_values = '${Q} 0.1 ${units 365 day -> s}'
  []
[]
